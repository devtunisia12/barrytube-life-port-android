...
void EV_SMGGUN(struct event_args_s *args);
void EV_SMGGUN2(struct event_args_s *args);
void EV_USB4K(struct event_args_s *args);
...
void EV_FireGlock2( event_args_t *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( GLOCK_SFIRE1, multiplayer ? 1 : 0 ); // iron on shoot anim
	...
	{
	case 0:
		gEngfuncs.pEventAPI->EV_PlaySound( idx, origin, CHAN_WEAPON, "weapons/pl_gun3.wav", gEngfuncs.pfnRandomFloat(0.8, 0.9), ATTN_NORM, 0, PITCH_NORM );
		break;
	case 1:
		gEngfuncs.pEventAPI->EV_PlaySound( idx, origin, CHAN_WEAPON, "weapons/pl_gun3.wav", gEngfuncs.pfnRandomFloat(0.8, 0.9), ATTN_NORM, 0, PITCH_NORM );
		break;
...
void EV_FireMP5( event_args_t *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( MP5_FIRE1, multiplayer ? 1 : 0 ); // iron off shoot anim
...
void EV_FireMP52( event_args_t *args )
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( MP5_SFIRE1, multiplayer ? 1 : 0 ); // iron on shoot anim
...
void EV_SMGGUN( event_args_t *args )
{
	int idx;
	vec3_t origin;
	vec3_t angles;
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( SMGGUN_FIRE1, multiplayer ? 1 : 0 ); // iron off shoot anim
	...
	{
	case 0:
		gEngfuncs.pEventAPI->EV_PlaySound( idx, origin, CHAN_WEAPON, "weapons/smgshoot1.wav", 1, ATTN_NORM, 0, 94 + gEngfuncs.pfnRandomLong( 0, 0xf ) );
		break;
	case 1:
		gEngfuncs.pEventAPI->EV_PlaySound( idx, origin, CHAN_WEAPON, "weapons/smgshoot2.wav", 1, ATTN_NORM, 0, 94 + gEngfuncs.pfnRandomLong( 0, 0xf ) );
		break;
	}
...
// We only predict the animation and sound
// The grenade is still launched from the server.
void EV_SMGGUN2( event_args_t *args )
{
	int idx;
	vec3_t origin;
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( SMGGUN_SFIRE1, multiplayer ? 1 : 0 ); // iron on shoot anim
...
void EV_USB4K( event_args_t *args )
{
	int idx;
	vec3_t origin;
	//vec3_t angles;
...
void EV_FireAK47(event_args_t *args)
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( AK47_SHOOT_1, multiplayer ? 1 : 0 ); // iron off shoot anim
...
void EV_FireAK472(event_args_t *args)
{
	...
	if ( EV_IsLocal( idx ) )
	{
		...
		// Add muzzle flash to current weapon model
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation( AK47_SFIRE1, multiplayer ? 1 : 0 ); // iron on shoot anim
