...
#define WEAPON_USB4K 25
#define WEAPON_SMGGUN 26
#define WEAPON_KICK				27
#define WEAPON_INTRO			28
...
#define SMGGUN_WEIGHT 15
#define USB4K_WEIGHT 15
...
class CSMGGUN : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
...
private:
	unsigned short m_usSMGGUN;
	unsigned short m_usSMGGUN2;
};
...
class CUsb4k : public CBasePlayerWeapon
{
public:
	void Spawn( void );
	void Precache( void );
