...
const char *CHAssassin::pIdleSounds[] =
{
	"karih/karihidle.wav",
};
...
const char *CHAssassin::pAttackSounds[] =
{
	"karih/karihattack.wav",
};
...
void CHAssassin::AttackSound( void )
{
	int pitch = 95 + RANDOM_LONG( 0, 9 );
...
void CHAssassin::Precache()
{
	...
	PRECACHE_SOUND("karih/karihidle.wav");
	PRECACHE_SOUND("karih/karihattack.wav");
	PRECACHE_SOUND("karih/karihdead.wav");
